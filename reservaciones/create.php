...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO reservacion2 (nombre, apellido, fecha_entrada, fecha_salida, adultos, kids, tipo_habitacion) 
            VALUES ('$nombre', '$apellido', '$fecha_entrada', '$fecha_salida', $adultos, $kids, $tipo_habitacion)";
